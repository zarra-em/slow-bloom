...
- side note: i used to think chocolate chip cookies required baking powder (not soda) because baking powder only needs a liquid to activate/react, while baking soda needs a liquid *and* an acid (e.g., adding vinegar, buttermilk, cocoa, etc)—think mild volcano experiment but in cookie form. anyway, even though chocolate chip cookies have chocolate chips (which obviously contain "acidic" cocoa), chocolate chips are actually considered neutral/basic since refined cocoa products usually have a pH of 6.8+. who would've thought? so, this was confusing until i found out that brown sugar was also considered acidic (because of its molasses content). sometimes chocolate chip cookie recipes even call for molasses as a flavour/texture enhancer (which makes sense because directly adding molasses contributes to the production of carbon dioxide via baking soda, making the cookie have a more cake-like texture). personally, i don't usually add molasses because it adds a vague gingerbread flavour, but to each their own.
